...
sidebar_tray_management = {
    ...
    "JA_JP": {
        "title": {
            "name": "サイドバー/トレイ管理",
            "description": "サイドバーとシステムトレイ関連設定を設定",
        }
    },
}
...
sidebar_management_window = {
    ...
    "JA_JP": {
        "title": {
            "name": "メインサイドバー",
            "description": "メインサイドバー管理関連設定を設定（再起動で有効）",
        },
        "roll_call_sidebar_position": {
            "name": "点呼サイドバー位置",
            "description": "点呼機能のサイドバー位置を設定（再起動で有効）",
        ...
        "main_window_history": {
            "name": "メインウィンドウ履歴位置",
            "description": "履歴機能のサイドバー位置を設定（再起動で有効）",
            "combo_items": ["上部", "下部", "非表示"],
        },
        "settings_icon": {
            "name": "設定アイコン位置",
            "description": "設定アイコンのサイドバー位置を設定（再起動で有効）",
            "combo_items": ["上部", "下部", "非表示"],
        },
    },
}
...
tray_management = {
    ...
    "EN_US": {
        ...
        "exit": {
            "name": "Exit app",
            "description": "Control whether to show exit option in tray menu",
        },
    },
    "JA_JP": {
        "title": {
            "name": "トレイ管理",
            "description": "システムトレイ関連設定を設定",
        },
        "show_hide_main_window": {
            "name": "メインウィンドウを一時的に表示/非表示",
            "description": "メインウィンドウの表示と非表示を制御",
            "switchbutton_name": {"enable": "", "disable": ""},
        },
        "open_settings": {
            "name": "設定ウィンドウを開く",
            "description": "トレイメニューに設定ウィンドウオプションを表示するかどうかを制御",
            "switchbutton_name": {"enable": "", "disable": ""},
        },
        "show_hide_float_window": {
            "name": "フローティングウィンドウを一時的に表示/非表示",
            "description": "フローティングウィンドウの表示と非表示を制御",
            "switchbutton_name": {"enable": "", "disable": ""},
        },
        "restart": {
            "name": "アプリを再起動",
            "description": "トレイメニューに再起動オプションを表示するかどうかを制御",
            "switchbutton_name": {"enable": "", "disable": ""},
        },
        "exit": {
            "name": "アプリを終了",
            "description": "トレイメニューに終了オプションを表示するかどうかを制御",
            "switchbutton_name": {"enable": "", "disable": ""},
        },
    },
}

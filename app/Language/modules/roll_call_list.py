...
name_setting = {
    ...
    "EN_US": {
        "title": {"name": "Name settings", "description": "Set name window title"},
        "description": {
        ...
        "input_title": {"name": "Name list", "description": "Name input area title"},
        "input_placeholder": {
...
group_setting = {
    ...
    "EN_US": {
        ...
        "input_title": {"name": "Group list", "description": "Group input area title"},
        "input_placeholder": {

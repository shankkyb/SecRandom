...
roll_call_list = {
    ...
    "EN_US": {
        ...
        "name_setting": {"name": "Name settings", "description": "Set student name"},
        "gender_setting": {
...
lottery_list = {
    ...
    "EN_US": {
        "title": {"name": "Lottery list", "description": "Manage prize list"},
        "set_pool_name": {
            "name": "Set pool name",
        ...
        "prize_setting": {"name": "Set prize", "description": "Set prize name"},

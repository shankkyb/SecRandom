...
history_management = {
    ...
    "EN_US": {
        ...
        "clear_roll_call_history": {
            ...
            "confirm_message": "Are you sure you want to clear the picking history for class '{name}'? This cannot be undone.",
            "success_message": "Picking history for class '{name}' has been cleared.",
            "error_message": "Failed to clear picking history: {error}",
        ...
        "clear_lottery_history": {
            ...
            "pushbutton_name": "Clear",
            "confirm_message": "Are you sure you want to clear the lottery history for pool '{name}'? This cannot be undone.",
